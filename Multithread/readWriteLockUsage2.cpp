...
void printNumber(const std::string& na){
    ...
    /*
     One of the features of the ordered associative container is that reading of the container can modify it. 
     This happens if the element is not available in the container. 
     If “Bjarne” is not found in the telephone book, a pair (“Bjarne”,0) will be created from the read access
     所以要用find method
    */
