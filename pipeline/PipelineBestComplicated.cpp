...
struct RegisterMap
{
    RegisterMap(string type, CreateCallback cb)
    {
        Pipeline::m_opCreate[type] = cb;
    }
};
...
public:
    ...
    static RegisterMap reg;
};
RegisterMap ConvertToGrayScale::reg("ConvertToGrayScale", ConvertToGrayScale::Create);
...
RegisterMap Blur::reg("Blur", Blur::Create);
...
RegisterMap Resize::reg("Resize", Resize::Create);
...
RegisterMap Blend::reg("BlendWith", Blend::Create);
